...
- **📦 Статус:** доступен с начала игры
- **⚡ Способность:** рывок

### <img src="README/Ingame3.png" width="20" height="20"> Jenny
- **📦 Статус:** открывается после 4 уровня
- **⚡ Способность:** лазать по стенам

### <img src="README/Ingame4.png" width="20" height="20"> Chockipie
- **📦 Статус:** открывается после финального уровня
- **⚡ Способность:** уменьшаться в размерах, чтобы пролезать в узкие щели
